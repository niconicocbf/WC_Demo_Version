...
import com.waitur.app.customer.adapter.ChooseSideAdapter;

public class ChooseSideActivity extends Activity {
	ListView listView;
	ChooseSideAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chooses_side);
		...
		adapter = new ChooseSideAdapter(this);
