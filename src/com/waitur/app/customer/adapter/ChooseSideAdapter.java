...
public class ChooseSideAdapter extends BaseAdapter {
	Context context;
	LayoutInflater inflater;
	List<Boolean> list = new ArrayList<Boolean>();

	public ChooseSideAdapter(Context context) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		;
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.listview_side_item, parent,
					false);
